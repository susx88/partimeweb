...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Panel de administración | Partime</title>
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="description" content="Panel de Administración - Partime">
    <meta name="author" content="Panel de Administración - Partime" />
    ...
    <link href="https://fonts.googleapis.com/css?family=Abril+Fatface" rel="stylesheet">
     ...
     <script type="text/javascript" src="assets/noty/packaged/jquery.noty.packaged.js"></script>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="?module=beranda" class="logo">
          <img style="margin-top:-5px;margin-right:0px" src="assets/img/logo.png" width="60px" alt="Logo"> 
          <span style="font-size:20px; font-family: Abril;">PARTIME WEB</span>
        </a>
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; <?php echo date('Y');?> - <a href="http://www.grupojega.cl/" target="_blank">Grupo Jega</a>.</strong>
      </footer>
    </div><!-- ./wrapper -->
